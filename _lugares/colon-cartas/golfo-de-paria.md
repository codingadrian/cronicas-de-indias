...
entity_id: place:golfo-de-paria
canonical_name: Golfo de Paria
aliases:
- Golfo de las Perlas
modern_equivalent: Golfo de Paria, entre Venezuela y Trinidad
mention_count_aprox: null
status: candidata
notas: Colón lo llamó 'Golfo de las Perlas'; el nombre moderno viene del pueblo local 'Paria' que menciona el propio texto
